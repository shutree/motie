...
<template>
    <div class="Finished" >
        <mt-header class="mtheader" title="完本专区" >
        ...
        <h4><span>最新完本</span></h4>
        <ul>
                <li class="li"  :key="index" v-for="(card, index) in 3">
                    <div class="left">
                        <img src="./wanben.jpg" height="172" width="240" alt="" />
                    </div>
                    <div class="right">
        ...
        <h4><span>热门完本</span></h4>
        <ul>
                <li class="li"  :key="index" v-for="(card, index) in 1">
                    <div class="left">
                        <img src="./wanben.jpg" height="172" width="240" alt="" />
                    </div>
                    <div class="right">
